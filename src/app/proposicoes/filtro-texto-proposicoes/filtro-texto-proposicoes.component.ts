...
@Component({
  selector: 'app-filtro-texto-proposicoes',
  templateUrl: './filtro-texto-proposicoes.component.html',
  styleUrls: ['./filtro-texto-proposicoes.component.scss']
})

export class FiltroTextoProposicoesComponent implements OnInit, AfterContentInit, OnDestroy {
